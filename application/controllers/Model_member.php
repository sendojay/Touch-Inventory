...
class Model_Member extends CI_Model{
    ...
    public function Call_from_Member_edit($id){
        ...
        $html = '
            ...
            <div class="form-group col-sm-6">
                <label for="message-text" class="control-label">นามสกุล:</label>
            ...
            <div class="form-group col-sm-6">
                <label for="message-text" class="control-label">เบอร์โทรศัพท์:</label>
                <input type="text" class="form-control" name="phone" value="'.$member["member_phone"].'" maxlength="80">
            </div>
            <div class="clearfix"></div>
            <div class="form-group col-sm-6">
                <label for="recipient-name" class="control-label">วันที่แก้ไขล่าสุด:</label>
                <input type="text" class="form-control" value="'.$member["member_date_modify"].'" disabled>
            </div>
            <div class="form-group col-sm-6">
                <label for="message-text" class="control-label">วันที่เข้าใช้งานล่าสุด:</label>
