...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="modal fade" id="Modal-form-add" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <?php echo form_open(base_url("Product/ProductAdd_save"), array("id" => "Form-add"));?>
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="exampleModalLabel1">Form Add Product</h4>
            </div>
            <div class="modal-body">
              ...
              <div class="form-group col-sm-6">
                ...
                echo form_dropdown('member', $arr_member, '', 'class="form-control"'); 
                ?>
              </div>
              <div class="clearfix"></div>
    ...
    <div class="modal fade" id="Modal-form-edit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <?php echo form_open(base_url("Product/ProductEdit_save"), array("id" => "Form-edit"));?>
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="exampleModalLabel1">Form Edit Product</h4>
            </div>
...
<script type="text/javascript">
  function searchFilter(page_num) {
      ...
      $.ajax({
          type: 'POST',
          url: '<?php echo base_url("Product/ProductView_ajax/"); ?>'+page_num,
  ...
  $("body").on("submit", "#Form-edit", function(){
    var data = call_ajax("<?php echo base_url("Product/ProductEdit_save");?>", $(this).serialize());
    if(data == 1){
