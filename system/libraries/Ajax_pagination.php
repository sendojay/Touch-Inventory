...
class CI_Ajax_pagination{
    ...
    function create_links(){
        ...
        if ($this->show_count){
            ...
            $info .= ' of Total ' . $this->total_rows;
            // $output .= $info;
            $showing = "<div class='col-sm-6 showing'>".$info."</div>";
        }
        ...
        $output = $showing.$this->full_tag_open.$output.$this->full_tag_close."<div class='clearfix'></div>";
        ?>
        <!-- <script>
